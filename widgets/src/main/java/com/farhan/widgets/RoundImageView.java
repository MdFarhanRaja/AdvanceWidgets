...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCircleBackgroundColor = a.getColor(R.styleable.RoundImageView_riv_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);

        int scaleType = a.getInt(R.styleable.RoundImageView_riv_scale_type, 7);
        switch (scaleType) {
            case 1:
